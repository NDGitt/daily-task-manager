    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              {hasChanges && (
                <button
                  onClick={handleReset}
                  className="px-2 py-1 text-xs sm:px-3 sm:py-2 sm:text-sm text-gray-600 hover:text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-gray-200 dark:hover:bg-gray-700 rounded-md transition-colors"
                >
                  Reset
                </button>
              )}
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1 ml-11">Customize your experience</p>
        </div>
      </div>
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
            <div className="px-4 py-4 sm:px-6 sm:py-5 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white">Task Behavior</h2>
              </div>
            </div>
            ...
            <div className="px-4 py-4 sm:px-6 sm:py-5 space-y-6">
              <div>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <label key={option.value} className="flex items-start gap-3 p-3 sm:p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer active:bg-gray-100 dark:active:bg-gray-600 transition-colors">
                      <input
                        type="radio"
                      ...
                      />
                      <div>
                        <div className="font-medium text-gray-900 dark:text-white text-sm sm:text-base">{option.label}</div>
                        <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mt-1">{option.description}</div>
                      </div>
                    </label>
                  ))}
                </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <span className="text-sm sm:text-base font-medium text-gray-900 dark:text-white min-w-[2.5rem] sm:min-w-[3rem] text-center">
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  <label className="text-sm sm:text-base font-medium text-gray-700 dark:text-gray-300">Smart suggestions</label>
                  <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mt-1">Get helpful task suggestions based on your patterns</p>
                </div>
                <button
                  onClick={() => updateSetting('smart_suggestions_enabled', !localSettings.smart_suggestions_enabled)}
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors flex-shrink-0 ${
                    localSettings.smart_suggestions_enabled ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-600'
                  }`}
                >
                  <span
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
            <div className="px-4 py-4 sm:px-6 sm:py-5 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white">Project Archiving</h2>
              </div>
            </div>
            ...
            <div className="px-4 py-4 sm:px-6 sm:py-5 space-y-6">
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  <label className="text-sm sm:text-base font-medium text-gray-700 dark:text-gray-300">Auto-archive completed projects</label>
                  <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mt-1">Automatically hide projects when all tasks are done</p>
                </div>
                <button
                  onClick={() => updateSetting('project_archive_completed', !localSettings.project_archive_completed)}
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors flex-shrink-0 ${
                    localSettings.project_archive_completed ? 'bg-green-600' : 'bg-gray-200 dark:bg-gray-600'
                  }`}
                >
                  <span
                    className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="flex-1 h-2 bg-gray-200 dark:bg-gray-700 rounded-lg appearance-none cursor-pointer"
                  />
                  <span className="text-sm sm:text-base font-medium text-gray-900 dark:text-white min-w-[3rem] sm:min-w-[4rem] text-center">
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
            <div className="px-4 py-4 sm:px-6 sm:py-5 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white">Data Management</h2>
              </div>
            </div>
            
            <div className="px-4 py-4 sm:px-6 sm:py-5 space-y-4">
              <div className="p-3 sm:p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                <h3 className="font-medium text-gray-900 dark:text-white mb-2 text-sm sm:text-base">Task History</h3>
              ...
              <div className="p-3 sm:p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                <h3 className="font-medium text-gray-900 dark:text-white mb-2 text-sm sm:text-base">Previous Days</h3>
                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-3">
